...
const pumpingBaselineTimeline = gsap.fromTo(
  "#pumping-oil #baseline",
  {
    rotation: 0,
...
const pumpingWeightTimeline = gsap.fromTo(
  "#pumping-oil #weight",
  {
    translateX: 0,
    translateY: 0,
...
const pumpingOilTimeline = gsap.fromTo(
  "#pumping-oil #oil-pipe circle",
  {
    translateY: 0,
  },
  {
